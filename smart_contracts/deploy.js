...
// Interface and bytecode object from compiled contract
const { interface, bytecode } = require('./compile')

// list of 12 words key to connect account. You can get this key when you setup a MetaMask
var mnemonic = 'climb tortoise bid duty develop name panic observe detail weird jewel music'

// Infur rinkeby API url.
// Specify ethereum network need to connect to
var accessToken = 'https://rinkeby.infura.io/atGUdFhaLSJXKBQ0a0h0'
...
const deploy = async () => {
  ...
  const result = await new web3.eth.Contract(JSON.parse(ABI))
    ...
    .send({ from: accounts[0], gas: '1000000' }) // 0.01 cent
